<template>
<header>
  <v-container fluid class="pa-0 tw-border-b-[1px]">
    <!-- tw-bg-[#f6f6ed] -->
    <v-row no-gutters class="tw-h-14  tw-px-12 tw-drop-shadow-sm">
      <v-col cols="12" >
        <v-row no-gutters class="tw-h-full tw-text-black">
          <v-col cols="3" 
            class="
              d-flex 
              justify-start 
            ...
            "
          >
            <router-link to="/"> LENS </router-link>
          </v-col>
          ...
          <v-col cols="6"   
            ...
            "
          >
            <v-row no-gutters class="tw-px-0">
              <v-col cols="12">
                <v-row no-gutters>
                  <v-col cols="2.4" class="d-flex justify-center align-center">
                    <router-link to="/product">
                      <div 
                        class="
                        tw-border-b-[1px]
                        tw-border-transparent
                        hover:tw-border-b-[1px]
...
<!-- 
          <v-col cols="3"  class="d-flex justify-start align-center">
            <v-row no-gutters class="tw-pl-10">
              <v-col cols="12" class="d-flex justify-end align-center">
                    ...
                    <router-link to="/mycart">
                      <div class="d-flex justify-end align-center tw-pl-4">
                        <v-img
                          :aspect-ratio="aspectRatio"
                          :width="24"
          ...
          <v-col cols="3"  class="d-flex justify-start align-center">
            <v-row no-gutters class="tw-pl-36">
              <v-col cols="12">
                <v-row no-gutters>
                  <!-- search ---------------------------------------------------------------------->
                  <!-- <v-col cols="3" class="d-flex justify-end align-center"> -->
                    <!-- <router-link to="/"> -->
                      ...
                      <!-- <div class="input-search"> -->
                            ...
                            ">
                              ...
                              >
                                ...
                                >
                                  ...
                                  <input placeholder="Search" v-on:keyup="filterByName()" v-model="msg" class="tw-h-full tw-bg-slate-300">  
                                  <h1>{{ msg }}</h1>
                                </div>
                                <v-col cols="12">
                                  <v-row no-gutters class="tw-h-full">
                                    <div v-for="item in showProducts" :key="item" class="tw-pr-4">
                                      {{item.name}}
                                    </div>
                                  </v-row>
                                </v-col>
                        ...
                        <!-- </div> -->
                        <!-- <input type="search" name="search" id="" placeholder="Search" v-on:change="filterByName()" v-model="msg">   -->
                        <!-- <input placeholder="Search" v-on:keyup="filterByName()" v-model="msg">   thissssssss-->
                        <!-- <h1>{{ msg }}</h1> -->
